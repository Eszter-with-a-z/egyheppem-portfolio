  ...
  return (
    ...
    >
      <div className="aspect-[4/3] relative overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-blue/80 via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      </div>
      <div className="p-4">
